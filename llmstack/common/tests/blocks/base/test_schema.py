...
class TestSchema(BaseSchema):
    ...
    test_int_range: int = Field(
        1, ge=0, le=10, description='test_int_range description',
    )
...
class TestBaseSchema(unittest.TestCase):
    def test_get_json_schema(self):
        ...
        self.assertEqual(
            json_schema.get('properties').get(
            'test_str',
            ).get('type'), 'string',
        )
        self.assertEqual(
    ...
    def test_get_ui_schema(self):
        ...
        self.assertEqual(
            ui_schema.get(
            'test_float',
            ).get('ui:widget'), 'updown',
        )
        self.assertEqual(
            ui_schema.get(
            'test_bool',
            ).get('ui:widget'), 'checkbox',
        )
        ...
        self.assertEqual(
            ui_schema.get(
            'test_textarea',
            ).get('ui:widget'), 'textarea',
        )
        self.assertEqual(
            ui_schema.get(
            'test_password',
            ).get('ui:widget'), 'password',
        )
