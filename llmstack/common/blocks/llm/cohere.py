...
class CohereGenerateAPIProcessor(LLMBaseProcessor[CohereGenerateAPIProcessorInput, CohereGenerateAPIProcessorOutput, CohereGenerateAPIProcessorConfiguration]):
    @staticmethod
    def name() -> str:
