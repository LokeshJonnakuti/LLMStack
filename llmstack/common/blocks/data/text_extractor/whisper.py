...
class WhisperTextExtractorInput(TextExtractorInput):
    ...
    def validate(cls, field_values):
        ...
        if mime_type not in ['audio/mp3', 'audio/mpeg', 'audio/wav', 'video/mp4', 'video/mpeg', 'video/webm']:
...
class WhisperTextExtractorProcessor(ProcessorInterface[WhisperTextExtractorInput, TextExtractorOutput, TextExtractorConfiguration]):
    def process(self, input: WhisperTextExtractorInput, configuration: TextExtractorConfiguration) -> TextExtractorOutput:
