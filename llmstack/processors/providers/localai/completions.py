...
from llmstack.common.blocks.llm.localai import LocalAICompletionsAPIProcessor
from llmstack.common.blocks.llm.localai import LocalAICompletionsAPIProcessorConfiguration
from llmstack.common.blocks.llm.localai import LocalAICompletionsAPIProcessorInput
from llmstack.common.blocks.llm.localai import LocalAICompletionsAPIProcessorOutput
...
class CompletionsConfiguration(ApiProcessorSchema):
    ...
    model: str = Field(
        description='Model name', widget='customselect',
